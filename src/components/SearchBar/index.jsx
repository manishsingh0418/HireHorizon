...
function SearchBar(props) { // Ensure 'props' is included if you're passing props to this component
  ...
  const handleChange = (e) => { // Add 'e' as a parameter
  ...
  return (
    <div className="flex gap-4 my-10 justify-center px-10">
      ...
      >
        ...
        <option value="Developer Advocated">Developer Advocated</option>
      </select>
